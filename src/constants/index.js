...
export const HERO_CONTENT = `I am a 3rd-year B.Tech CSE student with a passion for research, data analytics, and web development. Throughout my college journey, I have worked on multiple projects across domains such as data analysis, databases, automation, and machine learning. Also, I have developed a foundation in web development by learning HTML, CSS, and JavaScript. I am currently expanding my skills by learning React. I look forward to further exploring these domains and applying my skills to create impactful solutions.`;
...
export const CONTACT = {
  phoneNo: "+91 98757 11225",
  email: "niharikasharma@jklu.edu.in",
};
